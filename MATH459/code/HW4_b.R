...
fit3 <-MCMCprobit(chd~.,data=heart,thin=2, burnin=1000,mcmc =50000,b0=0, B0=.001, marginal.likelihood="Laplace")
fit4 <-MCMClogit(chd~.,data=heart,thin=2, burnin=1000,mcmc =50000,b0=0, B0=.001, marginal.likelihood="Laplace")
